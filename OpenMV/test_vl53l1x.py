...
# 平台: OpenMV N6 / H7 Plus + 星瞳科技测距扩展板 (VL53L1X)
# I2C: N6 → I2C(2) 已验证; H7 Plus → Shield 接口待排查
#
# 验证结果 (2026-05-26):
#   N6 + I2C(2): PASS — Model ID 0xEACC, 100/100 有效, ~2.9m, 33.3Hz, ±25mm
#   H7 Plus: FAIL — I2C(2) 扫描为空, 疑似 Shield 接触不良或 XSHUT 悬空
# ============================================================================
