# ⚠️ 已废弃 — HC6060A 双向双路差速有刷电机电调

> **状态**: ❌ **本项目不再使用 HC6060A**。实车使用两台三相无刷电机 + 两路独立无刷电调。
> **保留原因**: §4.6 独立款混控算法 (`differential_mix`) 与当前坦克混控逻辑一致，仍具参考价值。
> **废弃日期**: 2026-05-31
>
> ---
>
> **原用途**：给 Claude / 其他 AI 编程助手阅读，用于代码开发  
> **产品**：防水 HC6060A 双向双路差速有刷电调  
> **店铺**：淘宝「黑翅科技」| ¥353 起  
> **信息来源**：淘宝商品详情页截图（2026-05 确认）  
> **原版本**：🟢 **混控款**（内置混控，无需 MCU 做差速）  
> **最后更新**：2026-05-28
