...
OpenMV → ESP8266/ESP32 通过 P2 UART4 4800 baud (VIS ASCII 协议), ESP8266 ↔ STM32 通过 UART0 swapped (GPIO15/GPIO13, 115200 baud, 6-byte MotorCmd 下行 + 遥测上行)。
...
> ESP32-WROOM-32U (DevKit V1) 已重新启用 (2026-06-03) 作为备用 L2 控制器。详见 `ESP32_Solo/DEPRECATED.md`。
...
- OpenMV N6 →: P2 UART4 (4800 baud) → D5 (GPIO14) SoftwareSerial, VIS ASCII 协议 (XOR checksum)
